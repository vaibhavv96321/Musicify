...
import '../blocs/music_list_bloc.dart';
...
class NewMusicList extends StatefulWidget {
  @override
  _NewMusicListState createState() => _NewMusicListState();
}

class _NewMusicListState extends State<NewMusicList> {
                      ...
                      if (snapshot.hasData) {
                        switch (snapshot.data.status) {
                          ...
                          case Status.COMPLETED:
                            return TrackList(snapshot.data.data);
                            break;
                          case Status.ERROR:
                            break;
                        }
