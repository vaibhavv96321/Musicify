...
import 'package:musicify/blocs/connectivity_bloc.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:musicify/models/music_list.dart' as ListTrack;
            ...
            if (snapshot.hasData) {
              switch (snapshot.data) {
                ...
                case ConnectivityResult.wifi:
                  ...
                  return StreamBuilder<Response<MusicDetails>>(
